            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="{{url('admin')}}"><i data-feather="home"> </i><span>Tableau de board</span></a></li>
                    <li class="sidebar-list">
                        <a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="users"></i><span>Abonnes </span></a>
                    ...
                    <li class="sidebar-list">
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{url('admin/users')}}">Listes</a></li>
                    ...
                    <li class="sidebar-list"><a class="linear-icon-link sidebar-link sidebar-title"
                            href="#"><i data-feather="coffee"></i><span>Vol </span></a>
                        <ul class="sidebar-submenu">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="booking.html"><i data-feather="bookmark"> </i><span>Réservation</span></a>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="reviews.html"><i data-feather="message-square">
                            </i><span>Commentaires</span></a></li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="setting.html"><i data-feather="settings"> </i><span>Paramètre</span></a>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="login.html"><i data-feather="log-in"> </i><span>Connexion</span></a>
                    </li>

                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="sign-up.html"><i data-feather="plus-circle"> </i><span>S'inscrire</span></a>
                    </li>
