                            ...
                            <div class="row content grid">
                                <div class="col-sm-6 grid-item">
                                    <div class="special-box p-0">
                                        <div class="special-img tour-img">
                                        </div>
                                                ...
                                                <div class="include-sec">
                                                    ...
                                                    <ul class="include">
                                                        <li>
                                                            ...
                                                            <div class="ldr-text d-none d-xl-block"></div>
                                                        </li>
                                                        <li>
                                                            <div class="ldr-img"></div>
                                                            <div class="ldr-text d-none d-xl-block"></div>
                        ...
                        <div class="row  content grid">
                            ...
                            <div class="col-sm-6 popular grid-item wow fadeInUp" data-class="popular">
                                <div class="special-box p-0">
                                    ...
                                    <div class="special-content">
                                        <a href="tour-single-6.html">
                                            <h5>{{$voyage->nom_v}}<span>(6N 7D)</span></h5>
                                        </a>
                                        <div class="tour-detail">
                                            ...
                                            <div class="include-sec">
                                                ...
                                                <ul class="include">
                                                    ...
                                                    <li><img src="../assets/images/icon/tour/photo-camera.png"
                                                            class="img-fluid blur-up lazyload" alt=""
                                                            data-bs-toggle="tooltip" data-placement="top"
                                                            title="Sightseeing">sightseeing</li>
                                                    <li><img src="../assets/images/icon/tour/visa.png"
                                                            class="img-fluid blur-up lazyload" alt=""
                            ...
                            <div class="col-sm-6 trend grid-item wow fadeInUp" data-class="trend">
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="tour-single-6.html">
                                            <img src="../assets/images/tour/tour/10.jpg"
                                                class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                            <a href="#" class="" data-bs-toggle="tooltip" data-placement="top" title=""
                            ...
                            <div class="col-sm-6 popular grid-item wow fadeInUp" data-class="popular">
                                <div class="special-box p-0">
                                    <div class="special-img">
                                        <a href="tour-single-6.html">
                                            <img src="../assets/images/tour/tour/11.jpg"
                                                class="img-fluid blur-up lazyload bg-img" alt="">
                                        </a>
                                        <div class="top-icon">
                                            <a href="#" class="" data-bs-toggle="tooltip" data-placement="top" title=""
