                     ...
                     <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown">
                           <button class="btn dropdown-toggle" id="dropdownMenuButton" type="button"
                              data-bs-toggle="dropdown" aria-expanded="false">Hebdomadaire</button>
                           <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"><a
                                 class="dropdown-item" href="#">Hebdomadaire</a><a class="dropdown-item"
                     ...
                     <table class=" dashboard-table table border-0 ">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td><span><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                       viewBox="0 0 24 24">
            ...
            <div class="card ">
               <div class="d-flex align-items-center justify-content-between  card-header">
                  ...
                  <div class="btn-group" role="group" aria-label="Basic example">
                     <button class="btn btn-outline-light txt-dark " type="button" data-bs-original-title=""
                        title="">Journée</button>
                     <button class="btn btn-outline-light txt-dark" type="button" data-bs-original-title=""
                        title="">Semaine</button>
                     <button class="btn btn-outline-light txt-dark active" type="button" data-bs-original-title=""
                        title="">Mois</button>
                  </div>
               </div>
               <div class="card-body">
                        ...
                        <div class="category-box">
                           <div class="img-category">
                              ...
                              <div class="img-category-box">
                                 <img src="../../adm/assets/images/tours/1.jpg" alt="" class="img-fluid bg-img ">
                              </div>
                              <div class="top-bar">
