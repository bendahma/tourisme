...
@section('content')
    ...
    <div class="skeleton_loader">
       @include('layouts.header')
        ...
        <section class="bg-white pt-0 search-panel">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row  content grid">
                            ...
                            <div class="col-sm-6  popular grid-item wow fadeInUp" data-class="popular">
                                <div class="special-box">
                                    ...
                                    <div class="special-content">
                                        <a href="hotel-single-7.html">
                                            <h5>{{$hotel->nom_h}}<span><i class="fas fa-map-marker-alt"></i> {{$hotel->adresse_h}}</span>
                                            </h5>
                                        </a>
                                        <p>
                                            Lorem Ipsum is simply dummy text the printing Ipsum is simply Lorem Ipsum is
                                            simply dummy text of the Lorem Ipsum is simply dummy text the.
                                        </p>
                                        <div class="bottom-section">
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
